  ...
  return (
    <section id="faq" className="bg-white py-20">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          <motion.span 
            className="inline-block text-yellow-500 font-semibold mb-3"
            initial={{ opacity: 0 }}
          ...
          >
            ...
            <a href="#contact" className="text-yellow-600 hover:underline">Contact our support team</a>.
          </motion.p>
        </motion.div>
        ...
        >
          <div ref={searchRef} className="relative max-w-2xl mx-auto mb-8">
            <motion.input
              ...
              className="w-full px-5 py-4 pr-12 rounded-lg border border-green-200 focus:ring-2 focus:ring-yellow-300 focus:border-transparent transition-all duration-200 shadow-sm"
              value={searchTerm}
          ...
          >
            <motion.button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeCategory === 'all' ? 'bg-yellow-500 text-white' : 'bg-green-50 text-green-700 hover:bg-green-100'}`}
            ...
            {faqData.categories.map(category => (
              <motion.button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeCategory === category.id ? 'bg-yellow-500 text-white' : 'bg-green-50 text-green-700 hover:bg-green-100'}`}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                {category.name}
          ...
          {filteredItems.length > 0 ? (
            filteredItems.map((item, index) => (
              <motion.div 
                key={item.id}
                variants={item}
                className={`border border-green-100 rounded-xl transition-all duration-200 overflow-hidden ${activeIndex === index ? 'ring-2 ring-yellow-300 bg-green-50' : 'hover:border-yellow-300'}`}
              ...
              >
                ...
                >
                  ...
                  <motion.span 
                    className={`flex-shrink-0 ml-4 w-8 h-8 flex items-center justify-center rounded-full transition-colors ${activeIndex === index ? 'bg-yellow-500 text-white rotate-180' : 'bg-green-100 text-yellow-600'}`}
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            <motion.p 
              ...
              transition={{ delay: 0.2 }}
            >
              Our support team is available 24/5 to help you with any questions or issues you might have.
            </motion.p>
            <motion.div 
            ...
            >
              <motion.a 
                href="#contact" 
                className="px-6 py-3 bg-yellow-500 hover:bg-yellow-600 rounded-lg font-medium transition-colors"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Contact Support
