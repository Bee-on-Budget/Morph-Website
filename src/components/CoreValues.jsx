        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-8">
          ...
          <div className="w-full lg:w-1/2">
            <div className="mb-6 lg:mb-8">
              ...
              <p className="text-sm lg:text-base text-green-100 mb-4 lg:mb-6 max-w-md">
          ...
          <div className="w-full lg:w-1/2 mt-6 lg:mt-0">
            <div className="relative bg-white p-1 rounded-lg shadow-md border border-green-200 h-auto lg:h-[400px] flex flex-col">
              ...
              {/* Image caption */}
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-green-900/70 to-transparent p-2 lg:p-3">
              ...
              {/* Status indicator */}
              <div className="absolute top-2 right-2 bg-green-600 text-white text-xxs px-1.5 py-0.5 rounded-full flex items-center">
